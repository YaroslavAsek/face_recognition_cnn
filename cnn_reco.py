...
CHECKPOINT = r"weights\emotion_cnn_best.pth" # название файла для сохранения пути
...
#Чтобы избежать переобучения, будем менять изоюражения датасета потем отзеркаливания или поворотов
...
def plot_history(history: dict):
    ...
    plt.tight_layout()
    plt.savefig(r"photos\training_history.png", dpi=120)
    plt.show()
...
def main():
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        if val_acc > best_val_acc:
            ...
            print(f"  ✓ Веса сохранены (val_acc={val_acc*100:.2f}%)")

    print(f"\nЛучшая точность: {best_val_acc*100:.2f}%")
